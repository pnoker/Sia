...
public class DataReal implements Serializable {
    ...
    public DataReal(int nodeId, int adapterId, String name, String valueType, String writeAble, int tag, String
    ...
    public boolean equals(Object that) {
        ...
        return (this.getNodeId() == null ? other.getNodeId() == null : this.getNodeId().equals(other.getNodeId())) &&
				(this.getAdapterId() == null ? other.getAdapterId() == null : this.getAdapterId().equals(other
						.getAdapterId()))
                && (this.getName() == null ? other.getName() == null : this.getName().equals(other.getName())) &&
				(this.getValueType() == null ? other.getValueType() == null : this.getValueType().equals(other
						.getValueType()))
                && (this.getWriteAble() == null ? other.getWriteAble() == null : this.getWriteAble().equals(other
				.getWriteAble())) && (this.getTag() == null ? other.getTag() == null : this.getTag().equals(other
				.getTag()))
                && (this.getValue() == null ? other.getValue() == null : this.getValue().equals(other.getValue())) &&
				(this.getProtocolId() == null ? other.getProtocolId() == null : this.getProtocolId().equals(other
						.getProtocolId()))
