...
public class MainController extends BaseController {
    ...
    public String loginIn(HttpServletRequest request, HttpServletResponse response, @RequestParam String username,
                          @RequestParam String password, @RequestParam String validate,
    ...
    public void qrImage(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            String content = "http://" + request.getLocalAddr() + ":" + request.getLocalPort() + request
                    .getContextPath();
    ...
    public String calendar(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap, @RequestParam
