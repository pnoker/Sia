var typeStore = Ext.create('Ext.data.Store', {
    fields: ['text', 'value'],
    data: [
        { "text": "Input State", "value": "0" },
        { "text": "Coils", "value": "1" },
        { "text": "Input Register", "value": "2" },
        { "text": "Holding Register", "value": "3" }
    ]
});
        ...
        buttons: [{
            ...
            handler: function () {
                if (FormPanel.form.isValid()) {
                    Ext.Ajax.request({
                        method: 'get',
                        url: ctxPath + '/opcItems/cnfg/' + type + '.do',
                        params: {
                            dataRealId: FormPanel.getForm().findField('dataRealId').getValue(),
                            deviceId: FormPanel.getForm().findField('deviceId').getValue(),
                            modAddress: FormPanel.getForm().findField('modAddress').getValue(),
                            type: FormPanel.getForm().findField('type').getValue(),
                            rw: FormPanel.getForm().findField('rw').getValue(),
                            fre: FormPanel.getForm().findField('fre').getValue()
                        },
